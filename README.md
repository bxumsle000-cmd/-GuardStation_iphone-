...
#### 計畫功能
- **下架週期追蹤**：統計不同機型、價格區間的平均銷售週期
- **熱銷特徵分析**：識別快速售出商品的共同特徵（機型、容量、外觀、價格）
- **滯銷預警**：預測哪些商品可能長期滯銷，協助賣家調整策略
- **季節性趨勢**：觀察不同時期的銷售熱點（例如：新機發表前後的二手市場變化）

#### 資料需求
- **最小時間跨度**：需至少 3-6 個月的完整資料
- **目前狀態**：2026 年 1 月開始爬取，預計 2026 年中期可進行初步分析

#### 分析維度
1. **商品特性**：機型、容量、外觀等級、保固類型
2. **定價策略**：原價、優惠價與實際售價的關係
3. **地理分布**：不同分店的銷售速度差異
